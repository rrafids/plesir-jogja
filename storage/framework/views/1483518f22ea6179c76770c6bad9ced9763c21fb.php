        ...
        <div class="row">
            <div class="col-30">
                ...
                <div class="input-group mt-5 mb-4" style="width: 535px">
                    <input type="text" class="form-control ml-3" placeholder="Cari Obyek Wisata..." aria-label="Recipient's username" aria-describedby="basic-addon2" name="search" id="search">
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item my-3 mx-3">
                        <div class="card" style="width: 18rem">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><?php echo e($place['nama']); ?></h5>
